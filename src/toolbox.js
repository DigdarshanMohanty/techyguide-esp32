  ...
  contents: [
    ...
    },
    {
      ...
      contents: [
        ...
        { kind: "sep", gap: "12" },
        { kind: "block", type: "esp32_read_digital_pin", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 2 } } } } },
        { kind: "block", type: "esp32_read_analog_pin", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 34 } } } } },
        { kind: "block", type: "esp32_set_digital_pin", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 2 } } } } },
        { kind: "block", type: "esp32_set_pwm_pin", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 2 } } } } },
        { kind: "block", type: "esp32_get_touch_pin", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 4 } } } } },
        ...
        { kind: "block", type: "esp32_enable_servo", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_set_servo_angle", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_rotate_servo", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_detach_servo", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_free_motor" },
        { kind: "block", type: "esp32_enable_motor", inputs: {
          DIR1: { shadow: { type: "math_number", fields: { NUM: 26 } } },
          DIR2: { shadow: { type: "math_number", fields: { NUM: 27 } } },
          PWM:  { shadow: { type: "math_number", fields: { NUM: 14 } } },
        } },
        { kind: "block", type: "esp32_set_relay", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
        { kind: "block", type: "esp32_relay_toggle", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
        { kind: "block", type: "esp32_relay_state", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
        { kind: "block", type: "esp32_enable_led_control" },
        { kind: "block", type: "esp32_set_led_brightness", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 2 } } } } },
        { kind: "block", type: "esp32_pin_state_monitor" },

        { kind: "label", text: "Sensors", "web-class": "esp32-subcategory-label" },
        { kind: "block", type: "esp32_ultrasonic", inputs: {
          TRIG: { shadow: { type: "math_number", fields: { NUM: 5 } } },
          ECHO: { shadow: { type: "math_number", fields: { NUM: 18 } } },
        } },
        { kind: "block", type: "esp32_pir_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_ir_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 15 } } } } },
        { kind: "block", type: "esp32_rain_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 34 } } } } },
        { kind: "block", type: "esp32_ldr_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 35 } } } } },
        { kind: "block", type: "esp32_dht", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 4 } } } } },
        { kind: "block", type: "esp32_digital_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_analog_sensor", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 34 } } } } },
        { kind: "block", type: "esp32_potentiometer", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 34 } } } } },
        { kind: "block", type: "esp32_hall_magnet_detected" },

        { kind: "label", text: "Hall Sensor Module", "web-class": "esp32-subcategory-label" },
        { kind: "block", type: "esp32_hall_module_value", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_hall_module_detected", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },
        { kind: "block", type: "esp32_hall_module_wait", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 13 } } } } },

        { kind: "label", text: "MPU6050 / Gyroscope", "web-class": "esp32-subcategory-label" },
        { kind: "block", type: "esp32_mpu_init", inputs: {
        ...
        { kind: "block", type: "esp32_heart_init", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 32 } } } } },
        ...
        { kind: "block", type: "esp32_l298n_init", inputs: {
          IN1: { shadow: { type: "math_number", fields: { NUM: 26 } } },
          IN2: { shadow: { type: "math_number", fields: { NUM: 27 } } },
          ENA: { shadow: { type: "math_number", fields: { NUM: 14 } } },
          IN3: { shadow: { type: "math_number", fields: { NUM: 25 } } },
          IN4: { shadow: { type: "math_number", fields: { NUM: 33 } } },
          ENB: { shadow: { type: "math_number", fields: { NUM: 32 } } },
        } },
        ...
        { kind: "block", type: "esp32_tactile_switch", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 4 } } } } },
        { kind: "block", type: "esp32_wait_until_pressed", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 4 } } } } },
        { kind: "block", type: "esp32_when_switch_pressed", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 4 } } } } },
        { kind: "block", type: "esp32_slide_switch", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
        { kind: "block", type: "esp32_slide_switch_is_on", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
        { kind: "block", type: "esp32_slide_switch_is_off", inputs: { PIN: { shadow: { type: "math_number", fields: { NUM: 5 } } } } },
