...
def ultrasonic_read_once(trig, echo):
    trig.value(0)
    time.sleep_us(5)
...
forBlock["esp32_dht"] = function (block, generator) {
  ...
  generator.definitions_["dht_reader"] = `
def read_dht(sensor, reading):
    try:
        sensor.measure()
...
forBlock["esp32_analog_sensor"] = function (block, generator) {
  ...
  generator.definitions_[`adc_${pin}`] = `
...
forBlock["esp32_potentiometer"] = function (block, generator) {
  ...
  generator.definitions_[`pot_adc_${pin}`] = `
pot_${pin} = ADC(Pin(${pin}))
...
forBlock["esp32_rain_sensor"] = function (block, generator) {
  ...
  generator.definitions_[`rain_adc_${pin}`] = `
rain_adc_${pin} = ADC(Pin(${pin}))
...
forBlock["esp32_pir_sensor"] = function (block, generator) {
  ...
  generator.definitions_["pir_reader"] = `
def read_pir(sensor):
    detections = 0
    for _ in range(5):
        if sensor.value():
